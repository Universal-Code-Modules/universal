...
const Translations = () => {
     ...
     const translations = {
                ...
                uk: {
                  passwordResetSubject:'Зміна паролю для {{domain}}',
                  passwordResetContent:`<p>Доброго дня, {{username}}</p><p>Ви можете змінити ваш пароль <a href="{{link}}">тут</a>.</p><p>Всього найкращого</p><p>{{domain}}</p>`,
                  emailConfirmationSubject:'Підтвердження e-mail для {{domain}}',
                  emailConfirmationContent:`<p>Доброго дня, {{username}}</p><p>Ви можете підтвердити ваш e-mail <a href="{{link}}">тут</a>.</p><p>Всього найкращого</p><p>{{domain}}</p>`
