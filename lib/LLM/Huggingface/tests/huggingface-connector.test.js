...
const huggingFaceConnector = require('../huggingface-connector');
...
describe('HuggingFace Connector', () => {
    ...
    test("ZeroShotImageClassification", async () => {
        ...
        const res = await huggingFaceConnector.ZeroShotImageClassification(inputs, { candidate_labels: ['cat', 'dog'] });
